...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Voxerra.DevHttpsConnectionHelper+CustomAndroidMessageHandler+CustomHostnameVerifier, Voxerra", DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier.class, __md_methods);
	}
	...
	public DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier ()
	{
		...
		if (getClass () == DevHttpsConnectionHelper_CustomAndroidMessageHandler_CustomHostnameVerifier.class) {
			mono.android.TypeManager.Activate ("Voxerra.DevHttpsConnectionHelper+CustomAndroidMessageHandler+CustomHostnameVerifier, Voxerra", "", this, new java.lang.Object[] {  });
		}
	}
